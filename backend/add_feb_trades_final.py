...
trades = [
    ...
    # Feb 6 - Mixed/Small loss (LIGHT RED)
    ...
    # Feb 10 - Big winning day (DARK GREEN)
    ...
    # Feb 11 - Overtrading day (MIXED with 🔥 icon)
    ...
    # Feb 14 - Small profit (LIGHT GREEN)
