...
print("=== ADDING EXIT TIMES TO TRADES ===\n")
...
feb_trades = [
    ...
    # Feb 10 (Tuesday) - Big winning day (2 trades)
    ...
    # Feb 11 (Wednesday) - Overtrading day (4 trades)
    ...
    # Feb 12 (Thursday) - Good day (2 trades)
